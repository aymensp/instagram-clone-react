function MinProfile() {
  return (
    <div className="flex justify-between items-center  mt-14 ml-10  ">
      <img
        className="rounded-full border p-[2px] w-18 h-18"
      ...
      <div className="mx-4 flex-1">
        <h2 className="font-semibold">aymansmati </h2>
        <h2 className="text-sm ">Άιμαν</h2>
      </div>
      <button className="text-blue-400 text-sm font-semibold ">Siwtch</button>
    </div>
  );
}
